...
const RoyaltonStory = () => {
    ...
    useGSAP(() => {
        ...
        // Micro-animations within panels
            ...
            if(elements.length > 0) {
                gsap.fromTo(elements, 
                    ...
                    { 
                        ...
                        scrollTrigger: {
                            trigger: panel,
                            containerAnimation: gsap.getById("horizontalScroll"), // We need to define an ID for the main timeline if we want containerAnimation to work, or just rely on intersection observer for horizontal elements.
                            // Actually, containerAnimation is simpler. Let's give the main tween an ID
                        }
                    }
                )
            }
    ...
    return (
        <section ref={containerRef} className="relative w-full h-screen overflow-hidden bg-brand-dark z-20">
            {/* Background elements */}
            ...
            <div className="flex w-[400vw] h-full" id="panels-container">
                
                {/* Panel 1: Business Overview */}
                <div className="story-panel w-screen h-full flex items-center justify-center p-8 md:p-20 relative">
                    <div className="max-w-4xl w-full z-10 flex flex-col md:flex-row gap-12 items-center">
                        <div className="md:w-5/12 shrink-0">
                            <h2 className="text-6xl md:text-8xl font-heading leading-none text-transparent bg-clip-text bg-gradient-to-r from-brand-gold to-brand-gold-light animate-el pr-4 whitespace-nowrap">
                                OUR<br/>STORY&nbsp;
                            </h2>
                            <div className="h-1 w-24 bg-brand-gold mt-6 animate-el"></div>
                        </div>
                        <div className="md:w-7/12">
                            <p className="text-2xl md:text-3xl font-body font-light text-white leading-relaxed animate-el">
                            ...
                            <p className="text-xl text-white/70 mt-6 animate-el">
                ...
                {/* Panel 2: Vision */}
                <div className="story-panel w-screen h-full flex items-center justify-center p-8 md:p-20 relative">
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-[20vw] font-heading text-white/5 whitespace-nowrap select-none pointer-events-none">
                        VISION
                    </div>
                    <div className="max-w-5xl w-full z-10 text-center">
                        <p className="text-brand-blue-light font-body tracking-[0.3em] uppercase mb-8 text-sm md:text-base font-bold animate-el">
                            The Destination
                        </p>
                        <h3 className="text-4xl md:text-6xl lg:text-7xl font-heading text-white leading-tight animate-el">
                ...
                <div className="story-panel w-screen h-full flex items-center justify-center p-8 md:p-20 relative">
                    ...
                    <div className="max-w-5xl w-full z-10 text-center">
                        <p className="text-brand-purple font-body tracking-[0.3em] uppercase mb-8 text-sm md:text-base font-bold animate-el">
                            The Action
                        </p>
                        <h3 className="text-3xl md:text-5xl lg:text-6xl font-body font-light text-white leading-relaxed animate-el">
                ...
                <div className="story-panel w-screen h-full flex items-center justify-center p-4 md:p-12 relative">
                    <div className="max-w-7xl w-full z-10 flex flex-col h-full justify-center">
                        <div className="mb-12 text-center">
                            <h2 className="text-5xl md:text-7xl font-heading text-white animate-el">
                                CORE VALUES <span className="text-brand-gold">(I-LINK)</span>
                            </h2>
                        </div>
                        
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 md:gap-6 h-auto md:h-[40vh]">
                            {values.map((val, index) => (
                                <div key={index} className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 md:p-8 hover:bg-brand-gold/10 hover:border-brand-gold/30 transition-all duration-500 flex flex-col overflow-hidden animate-el">
                                    <div className="absolute -right-4 -top-8 text-9xl font-heading text-white/5 group-hover:text-brand-gold/10 transition-colors duration-500">
                                        {val.letter}
                                    </div>
                                    <h4 className="text-2xl md:text-3xl font-heading text-brand-gold mb-4 relative z-10 group-hover:translate-x-2 transition-transform duration-300">
                                        {val.title}
                                    </h4>
